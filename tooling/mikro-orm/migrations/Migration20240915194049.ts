...
export class Migration20240915194049 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql('alter table "collaboration"."thread" add constraint "thread_workspace_id_foreign" foreign key ("workspace_id") references "collaboration"."workspace" ("id") on update cascade;');
